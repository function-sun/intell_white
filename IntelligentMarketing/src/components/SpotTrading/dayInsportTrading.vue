        ...
        <div class="showchartTable" v-loading="loading">
            <el-row style="margin-top:10px">
                <el-col :span="12" style="padding: 0 20px;border-right: 1px dashed #EBEEF5;">
                    ...
                    <el-button style="margin:20px 0 10px 0" @click="exportExcel('CQ')">导出日内出清电价Excel文档</el-button>
                ...
                <el-col :span="12" style="padding: 0 20px;">
                    ...
                    <el-button style="margin:20px 0 10px 0" @click="exportExcel('CL')">导出日内出清电力Excel文档</el-button>
                    <div class="tableDetail">
...
export default {
    ...
    methods:{
        ...
        getdeclare() {
            let that = this
            that.loading = true
            let url = '/market/api/rnxhjy/getRnxhjyChartData'
            let params = {
        ...
        getTableData() {
            let that = this
            let url = '/market/api/rnxhjy/getRnxhjyTableData'
            let params = {
                dataTime: that.getTime(that.datePicker),
                windplantNo: that.windTurbines
            }
